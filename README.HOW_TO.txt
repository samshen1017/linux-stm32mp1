...
In the kernel source directory (sources/*/linux-stm32mp-5.15.67-stm32mp-r2-r0),
you have one kernel source tarball, the patches and one Makefile:
   - linux-5.15.67.tar.xz
   - 00*.patch
   - Makefile.sdk
...
---------------------------------------------------------
    ...
    Branch: v5.15-stm32mp
    Revision: v5.15-stm32mp-r2

    $ git clone https://github.com/STMicroelectronics/linux.git
    $ git checkout -b WORKING v5.15-stm32mp-r2
...
---------------------------------------------------------------
    ...
    $ cd linux-stable
    $ git checkout -b WORKING v5.15.67
